...
function Calculator(){
  ...
  // HERO aligned flush with content width; minimal internal padding; no white bands
  const hero = {
    ...
    padding:14, maxWidth:980, margin:'0 auto 16px', border:'1px solid rgba(255,255,255,.24)',
    minHeight: 180
  } as const;
...
/** Table — Hours centered, Money right, with header row */
